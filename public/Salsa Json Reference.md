...
```
  {
    ...
    description: 'Yes, we added habanero to give this some heat!   
...
```
  {
    ...
    description: 'Spanish Verde features tomatillo tomatoes, a variety that is ripe when it is green. Along with the tomatillos we blend in green chilies, onions, cilantro, lime, and Jose Madrid spices to create a very unique and extremely tasty salsa.   
...
```
  {
    ...
    description: 'Verde Hot has the Verde Mild base, but with Serrano peppers to make it Hot. This is the "Salsa King's" favorite salsa.  
